defmodule PublicEventsWeb.Users.UserControllerTest do
  ...
  describe "new user" do
    test "renders form", %{conn: conn} do
      conn = get(conn, Routes.users_user_path(conn, :new))
  ...
  describe "create user" do
    test "redirects to show when data is valid", %{conn: conn} do
      ...
      assert redirected_to(conn) == Routes.users_user_path(conn, :show, id)
  ...
  describe "edit user" do
    ...
    test "renders form for editing chosen user", %{conn: conn, user: user} do
      conn = get(conn, Routes.users_user_path(conn, :edit, user))
  ...
  describe "update user" do
    ...
    test "redirects when data is valid", %{conn: conn, user: user} do
      ...
      assert redirected_to(conn) == Routes.users_user_path(conn, :show, user)

      conn = get(conn, Routes.users_user_path(conn, :show, user))
